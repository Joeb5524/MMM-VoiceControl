...
module.exports = NodeHelper.create({
    ...
    _mapIntent(text) {
        ...
        if (text === "answer call") return { type: "CALL_ACCEPT", payload: {} };
        if (text === "decline call") return { type: "CALL_DECLINE", payload: {} };
        if (text === "hang up") return { type: "CALL_HANGUP", payload: {} };
